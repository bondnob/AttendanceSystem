...
public interface StaffLedgerDetailMapper {
    ...
    @Insert("""
            INSERT INTO staff_ledger_detail (ledger_id, employee_basic_id, station_point, team_name, shift_category, work_type, sort_no,
                jia_ban1, jia_ban2, yi_ban1, yi_ban2, bing_ban1, bing_ban2, ding_ban1, ding_ban2, ban_ban1, ban_ban2, yu_bei1, yu_bei2, yu_bei3, yu_bei4, daily_name, identity_type,
                extra_shift_json)
            VALUES (#{ledgerId}, #{employeeBasicId}, #{stationPoint}, #{teamName}, #{shiftCategory}, #{workType}, #{sortNo},
                #{jiaBan1}, #{jiaBan2}, #{yiBan1}, #{yiBan2}, #{bingBan1}, #{bingBan2}, #{dingBan1}, #{dingBan2}, #{banBan1}, #{banBan2}, #{yuBei1}, #{yuBei2}, #{yuBei3}, #{yuBei4}, #{dailyName}, #{identityType},
                #{extraShiftJson})
            """)
    ...
    @Update("""
            ...
            SET station_point = #{stationPoint}, team_name = #{teamName}, shift_category = #{shiftCategory},
                ...
                ban_ban1 = #{banBan1}, ban_ban2 = #{banBan2},
    ...
    @Insert("""
            ...
            <foreach collection="list" item="d" separator=",">
                (#{d.ledgerId}, #{d.employeeBasicId}, #{d.stationPoint}, #{d.teamName}, #{d.shiftCategory}, #{d.workType}, #{d.sortNo},
                 #{d.jiaBan1}, #{d.jiaBan2}, #{d.yiBan1}, #{d.yiBan2}, #{d.bingBan1}, #{d.bingBan2}, #{d.dingBan1}, #{d.dingBan2}, #{d.banBan1}, #{d.banBan2}, #{d.yuBei1}, #{d.yuBei2}, #{d.yuBei3}, #{d.yuBei4}, #{d.dailyName}, #{d.identityType},
                 #{d.extraShiftJson})
            </foreach>
            </script>
            """)
