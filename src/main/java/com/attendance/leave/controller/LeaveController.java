...
public class LeaveController {
    ...
    private final LeaveSubmitService leaveSubmitService;
    ...
    public ApiResponse<LeaveDetailResponse> createLeave(@Valid @RequestBody CreateLeaveRequestDto request) {
        return ApiResponse.success("请假记录单提交成功", leaveSubmitService.createLeave(request));
    }
    ...
    public ApiResponse<LeaveDetailResponse> updateRejectedLeave(@PathVariable Long leaveId,
        ...
        return ApiResponse.success("请假记录单修改并重新提交成功", leaveSubmitService.updateRejectedLeave(leaveId, request));
    }
    ...
    public ApiResponse<Void> deleteRejectedLeave(@PathVariable Long leaveId) {
        leaveSubmitService.deleteRejectedLeave(leaveId);
    ...
    public ApiResponse<LeaveDetailResponse> approve(@PathVariable Long leaveId,
        ...
        return ApiResponse.success("审批完成", leaveApprovalService.approve(leaveId, request));
    }
    ...
    public ApiResponse<BatchApproveLeaveResponse> batchApprove(@Valid @ModelAttribute BatchApproveLeaveDto request) {
        return ApiResponse.success("批量审批完成", leaveApprovalService.batchApprove(request));
    }
    ...
    public ApiResponse<LeaveDetailResponse> cancel(@PathVariable Long leaveId,
        ...
        return ApiResponse.success("撤销成功", leaveSubmitService.cancelLeave(leaveId, request));
    }
    ...
    public ApiResponse<LeaveDetailResponse> uploadHandwrittenSignature(@PathVariable Long leaveId,
        ...
        return ApiResponse.success("手写签名上传成功", leaveApprovalService.uploadHandwrittenSignature(leaveId, request));
    }
    ...
    public ApiResponse<LeaveDetailResponse> uploadTeamLeaderSignatureDate(@PathVariable Long leaveId,
        ...
        return ApiResponse.success("班组长签字日期上传成功", leaveApprovalService.uploadTeamLeaderSignatureDate(leaveId, request.getSignatureDate()));
    }
    ...
    public ApiResponse<LeaveDetailResponse> updateSubmittedAt(@PathVariable Long leaveId,
        ...
        return ApiResponse.success("申请时间修改成功", leaveSubmitService.updateSubmittedAt(leaveId, request.getSubmittedAt()));
    }
    ...
    public ApiResponse<LeaveDetailResponse> updateSignatureDate(@PathVariable Long leaveId,
        ...
        return ApiResponse.success("签字日期修改成功", leaveSubmitService.updateSignatureDate(leaveId, request.getStepNo(), request.getSignatureDate()));
    }
    ...
    public ApiResponse<ApprovalSignatureUploadResponse> uploadApprovalSignature(@PathVariable Long leaveId,
        ...
        return ApiResponse.success("电子签名上传成功", leaveApprovalService.uploadApprovalSignature(leaveId, request));
    }
    ...
    public ApiResponse<LeaveDetailResponse> selectApprovers(@PathVariable Long leaveId,
        ...
        return ApiResponse.success("选择审批人完成", leaveApprovalService.selectApprovers(leaveId, request));
    }
    ...
    public ApiResponse<LeaveDetailResponse> reSelectApprovers(@PathVariable Long leaveId,
                                                              @Valid @RequestBody SelectApproversDto request) {
        return ApiResponse.success("重选领导成功", leaveApprovalService.reSelectApprovers(leaveId, request));
    }
    ...
    public ApiResponse<LeaveDetailResponse> getDetail(@PathVariable Long leaveId) {
        return ApiResponse.success(leaveQueryService.getLeaveDetail(leaveId));
    }
    ...
    public ApiResponse<LeavePdfResponse> getPdf(@PathVariable Long leaveId) {
        return ApiResponse.success(leaveQueryService.getLeavePdf(leaveId));
    }
    ...
    public ApiResponse<BatchLeavePdfResponse> batchDownloadPdf(@Valid @RequestBody BatchLeavePdfRequest request) {
        return ApiResponse.success(leaveQueryService.batchDownloadPdf(request));
    }
    ...
    public ApiResponse<List<SelectedApproverResponse>> getSelectedApprovers(@PathVariable Long leaveId) {
        return ApiResponse.success(leaveQueryService.getSelectedApprovers(leaveId));
    }
    ...
    public ApiResponse<PageResponse<LeaveListItemResponse>> list(@RequestParam(required = false) String status,
        ...
        return ApiResponse.success(leaveQueryService.listLeaves(status, leaveTypeId, pageNum, pageSize));
    }
